...
Collected data from Kaggle for this project.We are required to model the price of cars with the available indepedent variables.it will be used by the management to understand how exactly the prices of the cars may vary.
